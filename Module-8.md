...
พร้อมกับ Workshop ที่เน้นการนำไปใช้งานจริงในระดับ Production โดยใช้ตัวอย่างของระบบ Monitoring ซึ่งเป็นส่วนสำคัญของงาน Infrastructure
...
โค้ดชุดนี้คือการตั้งค่าไฟล์ `docker-compose.yml` สำหรับนำไปรันบน **Docker Swarm** ผ่านคำสั่ง `docker stack deploy` โดยแบ่งการอธิบายออกเป็นส่วนๆ ดังนี้:
